...
const Drawer: FunctionComponent<PropsWithChildren<DrawerProps>> = ({
  ...
  return (
    <>
      ...
      <div
        className={`${className} fixed inset-y-0 z-[999] w-96 max-w-[calc(100%-0.5rem)] bg-white p-1 shadow-xl transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        />
        <div className="z-[999] h-full overflow-y-auto p-2">{children}</div>
      </div>
    </>
  )
}
